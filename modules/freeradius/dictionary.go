...
// Code generation tool https://github.com/layeh/radius/tree/master/cmd/radius-dict-gen.
// Used dictionary: dictionary.freeradius.internal from /usr/share/freeradius/ directory (freeradius 3.0.12+dfsg-5+deb9u1)
// All attributes except  PacketType were removed to reduce the amount of generated code.

// Code generated by radius-dict-gen. DO NOT EDIT.

type PacketType uint32

const PacketType_Type radius.Type = 1047
...
const (
	...
	PacketType_Value_ResourceFreeRequest             PacketType = 21
	PacketType_Value_ResourceFreeResponse            PacketType = 22
	PacketType_Value_ResourceQueryRequest            PacketType = 23
	PacketType_Value_ResourceQueryResponse           PacketType = 24
	PacketType_Value_AlternateResourceReclaimRequest PacketType = 25
	PacketType_Value_NASRebootRequest                PacketType = 26
	PacketType_Value_NASRebootResponse               PacketType = 27
	PacketType_Value_NextPasscode                    PacketType = 29
	PacketType_Value_NewPin                          PacketType = 30
	PacketType_Value_TerminateSession                PacketType = 31
	PacketType_Value_PasswordExpired                 PacketType = 32
	PacketType_Value_EventRequest                    PacketType = 33
	PacketType_Value_EventResponse                   PacketType = 34
	PacketType_Value_DisconnectRequest               PacketType = 40
	PacketType_Value_DisconnectACK                   PacketType = 41
	PacketType_Value_DisconnectNAK                   PacketType = 42
	PacketType_Value_CoARequest                      PacketType = 43
	PacketType_Value_CoAACK                          PacketType = 44
	PacketType_Value_CoANAK                          PacketType = 45
	PacketType_Value_IPAddressAllocate               PacketType = 50
	PacketType_Value_IPAddressRelease                PacketType = 51
)
...
var PacketType_Strings = map[PacketType]string{
	...
	PacketType_Value_ResourceFreeRequest:             "Resource-Free-Request",
	PacketType_Value_ResourceFreeResponse:            "Resource-Free-Response",
	PacketType_Value_ResourceQueryRequest:            "Resource-Query-Request",
	PacketType_Value_ResourceQueryResponse:           "Resource-Query-Response",
	PacketType_Value_AlternateResourceReclaimRequest: "Alternate-Resource-Reclaim-Request",
	PacketType_Value_NASRebootRequest:                "NAS-Reboot-Request",
	PacketType_Value_NASRebootResponse:               "NAS-Reboot-Response",
	PacketType_Value_NextPasscode:                    "Next-Passcode",
	PacketType_Value_NewPin:                          "New-Pin",
	PacketType_Value_TerminateSession:                "Terminate-Session",
	PacketType_Value_PasswordExpired:                 "Password-Expired",
	PacketType_Value_EventRequest:                    "Event-Request",
	PacketType_Value_EventResponse:                   "Event-Response",
	PacketType_Value_DisconnectRequest:               "Disconnect-Request",
	PacketType_Value_DisconnectACK:                   "Disconnect-ACK",
	PacketType_Value_DisconnectNAK:                   "Disconnect-NAK",
	PacketType_Value_CoARequest:                      "CoA-Request",
	PacketType_Value_CoAACK:                          "CoA-ACK",
	PacketType_Value_CoANAK:                          "CoA-NAK",
	PacketType_Value_IPAddressAllocate:               "IP-Address-Allocate",
	PacketType_Value_IPAddressRelease:                "IP-Address-Release",
}
