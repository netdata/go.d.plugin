...
var (
	...
	tableScansRowsChartTmpl = module.Chart{
		...
		Dims: module.Dims{
			{ID: "db_%s_schema_%s_table_%s_idx_tup_fetch", Name: "index", Algo: module.Incremental},
			{ID: "db_%s_schema_%s_table_%s_seq_tup_read", Name: "sequential", Algo: module.Incremental},
		},
	}
