		...
		"Success on all queries (v14.4)": {
			{
				...
				check: func(t *testing.T, pg *Postgres) {
					...
					expected := map[string]int64{
						...
						"table_pgbench_accounts_db_postgres_schema_public_last_autoanalyze_ago": -1,
						"table_pgbench_accounts_db_postgres_schema_public_last_autovacuum_ago":  -1,
						...
						"table_pgbench_branches_db_postgres_schema_public_last_autoanalyze_ago": -1,
						"table_pgbench_branches_db_postgres_schema_public_last_autovacuum_ago":  -1,
						...
						"table_pgbench_history_db_postgres_schema_public_last_autoanalyze_ago":  -1,
						"table_pgbench_history_db_postgres_schema_public_last_autovacuum_ago":   -1,
						...
						"table_pgbench_tellers_db_postgres_schema_public_last_autoanalyze_ago":  -1,
						"table_pgbench_tellers_db_postgres_schema_public_last_autovacuum_ago":   -1,
