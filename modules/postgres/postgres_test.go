		...
		"Success on all queries, collect all dbs (v14.4)": {
			{
				...
				check: func(t *testing.T, pg *Postgres) {
					...
					expected := map[string]int64{
						...
						"index_myaccounts_email_key_table_myaccounts_db_postgres_schema_myschema_bloat_size":               0,
						"index_myaccounts_email_key_table_myaccounts_db_postgres_schema_myschema_bloat_size_perc":          0,
						...
						"index_myaccounts_email_key_table_myaccounts_db_postgres_schema_public_bloat_size":                 0,
						"index_myaccounts_email_key_table_myaccounts_db_postgres_schema_public_bloat_size_perc":            0,
						...
						"index_myaccounts_pkey_table_myaccounts_db_postgres_schema_myschema_bloat_size":                    0,
						"index_myaccounts_pkey_table_myaccounts_db_postgres_schema_myschema_bloat_size_perc":               0,
						...
						"index_myaccounts_pkey_table_myaccounts_db_postgres_schema_public_bloat_size":                      0,
						"index_myaccounts_pkey_table_myaccounts_db_postgres_schema_public_bloat_size_perc":                 0,
						...
						"index_myaccounts_username_key_table_myaccounts_db_postgres_schema_myschema_bloat_size":            0,
						"index_myaccounts_username_key_table_myaccounts_db_postgres_schema_myschema_bloat_size_perc":       0,
						...
						"index_myaccounts_username_key_table_myaccounts_db_postgres_schema_public_bloat_size":              0,
						"index_myaccounts_username_key_table_myaccounts_db_postgres_schema_public_bloat_size_perc":         0,
						...
						"index_pgbench_branches_pkey_table_pgbench_branches_db_postgres_schema_public_bloat_size":          0,
						"index_pgbench_branches_pkey_table_pgbench_branches_db_postgres_schema_public_bloat_size_perc":     0,
						...
						"index_pgbench_tellers_pkey_table_pgbench_tellers_db_postgres_schema_public_bloat_size":            0,
						"index_pgbench_tellers_pkey_table_pgbench_tellers_db_postgres_schema_public_bloat_size_perc":       0,
