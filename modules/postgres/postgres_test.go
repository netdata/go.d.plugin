		...
		"Success on all queries (v14.4)": {
			{
				...
				check: func(t *testing.T, pg *Postgres) {
					...
					expected := map[string]int64{
						...
						"db_postgres_schema_public_table_pgbench_accounts_n_dead_tup":         1000048,
						"db_postgres_schema_public_table_pgbench_accounts_n_dead_tup_perc":    16,
						...
						"db_postgres_schema_public_table_pgbench_accounts_n_tup_hot_upd_perc": 0,
						...
						"db_postgres_schema_public_table_pgbench_branches_n_dead_tup_perc":    0,
						...
						"db_postgres_schema_public_table_pgbench_branches_n_tup_hot_upd_perc": 0,
						...
						"db_postgres_schema_public_table_pgbench_history_n_dead_tup_perc":     0,
						...
						"db_postgres_schema_public_table_pgbench_history_n_tup_hot_upd_perc":  0,
						...
						"db_postgres_schema_public_table_pgbench_tellers_n_dead_tup_perc":     0,
						...
						"db_postgres_schema_public_table_pgbench_tellers_n_tup_hot_upd_perc":  0,
