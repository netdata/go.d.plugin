...
func TestRabbitMQ_Collect(t *testing.T) {
	...
	expected := map[string]int64{
		...
		"run_queue":                                        0,
		"sockets_used":                                     40,
		"vhost_check_api_message_stats_ack":                208961440,
		"vhost_check_api_message_stats_confirm":            210205428,
		"vhost_check_api_message_stats_deliver":            209220446,
		"vhost_check_api_message_stats_deliver_get":        209220446,
		"vhost_check_api_message_stats_deliver_no_ack":     0,
		"vhost_check_api_message_stats_get":                0,
		"vhost_check_api_message_stats_get_no_ack":         0,
		"vhost_check_api_message_stats_publish":            209597605,
		"vhost_check_api_message_stats_publish_in":         0,
		"vhost_check_api_message_stats_publish_out":        0,
		"vhost_check_api_message_stats_redeliver":          210205428,
		"vhost_check_api_message_stats_return_unroutable":  210205428,
		"vhost_search_api_message_stats_ack":               210205368,
		"vhost_search_api_message_stats_confirm":           174130170,
		"vhost_search_api_message_stats_deliver":           210205428,
		"vhost_search_api_message_stats_deliver_get":       210205428,
		"vhost_search_api_message_stats_deliver_no_ack":    210205428,
		"vhost_search_api_message_stats_get":               210205428,
		"vhost_search_api_message_stats_get_no_ack":        210205428,
		"vhost_search_api_message_stats_publish":           210127507,
		"vhost_search_api_message_stats_publish_in":        0,
		"vhost_search_api_message_stats_publish_out":       0,
		"vhost_search_api_message_stats_redeliver":         60,
		"vhost_search_api_message_stats_return_unroutable": 210205428,
	}
...
func TestRabbitMQ_AddVhostsChartsAfterCollect(t *testing.T) {
	...
	assert.True(t, job.charts.Has("vhost_search_api_message_stats"))
	assert.True(t, job.charts.Has("vhost_check_api_message_stats"))
}
