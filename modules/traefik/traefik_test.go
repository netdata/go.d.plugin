	...
	tests := map[string]struct {
		...
		"success on valid response v2.2.1": {
			...
			wantCollected: map[string]int64{
				...
				"entrypoint_request_duration_average_traefik_http_2xx":  1,
				...
				"entrypoint_request_duration_average_web_http_2xx":      62,
				"entrypoint_request_duration_average_web_http_3xx":      14,
				"entrypoint_request_duration_average_web_http_4xx":      91,
				"entrypoint_request_duration_average_web_http_5xx":      9479,
				...
				"entrypoint_request_duration_average_web_websocket_4xx": 12,
