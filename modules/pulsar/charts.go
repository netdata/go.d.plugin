...
var (
	...
	sumStorageWriteLatencyChart = Chart{
		...
		Opts:  Opts{StoreFirst: true},
		Dims: Dims{
			{ID: "pulsar_storage_write_latency_le_0_5", Name: "<=0.5ms"},
			{ID: "pulsar_storage_write_latency_le_1", Name: "<=1ms"},
			{ID: "pulsar_storage_write_latency_le_5", Name: "<=5ms"},
			{ID: "pulsar_storage_write_latency_le_10", Name: "<=10ms"},
			{ID: "pulsar_storage_write_latency_le_20", Name: "<=20ms"},
			{ID: "pulsar_storage_write_latency_le_50", Name: "<=50ms"},
			{ID: "pulsar_storage_write_latency_le_100", Name: "<=100ms"},
			{ID: "pulsar_storage_write_latency_le_200", Name: "<=200ms"},
			{ID: "pulsar_storage_write_latency_le_1000", Name: "<=1s"},
			{ID: "pulsar_storage_write_latency_overflow", Name: ">1s"},
		},
	}
	sumEntrySizeChart = Chart{
		...
		Opts:  Opts{StoreFirst: true},
		Dims: Dims{
			{ID: "pulsar_entry_size_le_128", Name: "<=128B"},
			{ID: "pulsar_entry_size_le_512", Name: "<=512B"},
			{ID: "pulsar_entry_size_le_1_kb", Name: "<=1KB"},
			{ID: "pulsar_entry_size_le_2_kb", Name: "<=2KB"},
			{ID: "pulsar_entry_size_le_4_kb", Name: "<=4KB"},
			{ID: "pulsar_entry_size_le_16_kb", Name: "<=16KB"},
			{ID: "pulsar_entry_size_le_100_kb", Name: "<=100KB"},
			{ID: "pulsar_entry_size_le_1_mb", Name: "<=1MB"},
			{ID: "pulsar_entry_size_le_overflow", Name: ">1MB"},
		},
	}
