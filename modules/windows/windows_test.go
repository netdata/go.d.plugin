...
func TestWindows_Collect(t *testing.T) {
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			prepare: prepareWindowsV0200,
			wantCollected: map[string]int64{
				"ad_atq_average_request_latency_period":                                                         0,
				"ad_atq_outstanding_requests_total":                                                             0,
				"ad_binds_total":                                                                                184,
				...
				"ad_directory_operations_read_total_directory_service_api":                                      0,
				"ad_directory_operations_read_total_knowledge_consistency_checker":                              60,
				"ad_directory_operations_read_total_local_security_authority":                                   20,
				"ad_directory_operations_read_total_name_service_provider_interface":                            0,
				"ad_directory_operations_read_total_other":                                                      50,
				"ad_directory_operations_read_total_replication_agent":                                          0,
				"ad_directory_operations_read_total_security_account_manager":                                   596,
				"ad_directory_operations_search_total_directory_service_api":                                    101,
				"ad_directory_operations_search_total_knowledge_consistency_checker":                            21,
				"ad_directory_operations_search_total_ldap":                                                     606,
				"ad_directory_operations_search_total_local_security_authority":                                 9,
				"ad_directory_operations_search_total_name_service_provider_interface":                          0,
				"ad_directory_operations_search_total_other":                                                    56,
				"ad_directory_operations_search_total_replication_agent":                                        0,
				"ad_directory_operations_search_total_security_account_manager":                                 38,
				"ad_directory_operations_write_total_directory_service_api":                                     3,
				"ad_directory_operations_write_total_knowledge_consistency_checker":                             0,
				"ad_directory_operations_write_total_ldap":                                                      1,
				"ad_directory_operations_write_total_local_security_authority":                                  0,
				"ad_directory_operations_write_total_name_service_provider_interface":                           0,
				"ad_directory_operations_write_total_other":                                                     1,
				"ad_directory_operations_write_total_replication_agent":                                         0,
				"ad_directory_operations_write_total_security_account_manager":                                  26,
