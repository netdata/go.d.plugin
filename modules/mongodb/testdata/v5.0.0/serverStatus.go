...
var V500ServerStatusMissingValues = []string{
	"mem.mapped",
	"mem.mappedWithJournal",
	"network.currentActive",
	"network.currentInactive",
	"network.currentOpen",
	"network.currentPrepared",
	"wiredtiger.block_manager.bytes_read",
	"wiredtiger.block_manager.bytes_read_via_memory_map_API",
	"wiredtiger.block_manager.bytes_read_via_system_call_API",
	"wiredtiger.block_manager.bytes_written",
	"wiredtiger.block_manager.bytes_written_for_checkpoint",
	"wiredtiger.block_manager.bytes_written_via_memory_map_API",
	"wiredtiger.cache.bytes_allocated_for_updates",
	"wiredtiger.cache.bytes_read_into_cache",
	"wiredtiger.cache.bytes_written_from_cache",
	"wiredtiger.capacity.time_waiting_due_to_total_capacity_(usecs)",
	"wiredtiger.capacity.time_waiting_during_checkpoint_(usecs)",
	"wiredtiger.capacity.time_waiting_during_eviction_(usecs)",
	"wiredtiger.capacity.time_waiting_during_logging_(usecs)",
	"wiredtiger.capacity.time_waiting_during_read_(usecs)",
	"wiredtiger.connection.memory_allocations",
	"wiredtiger.connection.memory_frees",
	"wiredtiger.connection.memory_re_allocations",
	"wiredtiger.cursor.open_cursor_count",
	"wiredtiger.cursor.cached_cursor_count",
	"wiredtiger.cursor.cursor_bulk_loaded_cursor_insert_calls",
	"wiredtiger.cursor.cursor_close_calls_that_result_in_cache",
	"wiredtiger.cursor.cursor_create_calls",
	"wiredtiger.cursor.cursor_insert_calls",
	"wiredtiger.cursor.cursor_modify_calls",
	"wiredtiger.cursor.cursor_next_calls",
	"wiredtiger.cursor.cursor_operation_restarted",
	"wiredtiger.cursor.cursor_prev_calls",
	"wiredtiger.cursor.cursor_remove_calls",
	"wiredtiger.cursor.cursor_remove_key_bytes_removed",
	"wiredtiger.cursor.cursor_reserve_calls",
	"wiredtiger.cursor.cursor_reset_calls",
	"wiredtiger.cursor.cursor_search_calls",
	"wiredtiger.cursor.cursor_search_history_store_calls",
	"wiredtiger.cursor.cursor_search_near_calls",
	"wiredtiger.cursor.cursor_sweep_buckets",
	"wiredtiger.cursor.cursor_sweep_cursors_closed",
	"wiredtiger.cursor.cursor_sweep_cursors_examined",
	"wiredtiger.cursor.cursor_sweeps",
	"wiredtiger.cursor.cursor_truncate_calls",
	"wiredtiger.cursor.cursor_update_calls",
	"wiredtiger.cursor.cursor_update_value_size_change",
	"wiredtiger.lock.checkpoint_lock_acquisitions",
	"wiredtiger.lock.dhandle_read_lock_acquisitions",
	"wiredtiger.lock.dhandle_write_lock_acquisitions",
	"wiredtiger.lock.durable_timestamp_queue_read_lock_acquisitions",
	"wiredtiger.lock.durable_timestamp_queue_write_lock_acquisitions",
	"wiredtiger.lock.metadata_lock_acquisitions",
	"wiredtiger.lock.read_timestamp_queue_read_lock_acquisitions",
	"wiredtiger.lock.read_timestamp_queue_write_lock_acquisitions",
	"wiredtiger.lock.schema_lock_acquisitions",
	"wiredtiger.lock.table_read_lock_acquisitions",
	"wiredtiger.lock.table_write_lock_acquisitions",
	"wiredtiger.lock.txn_global_read_lock_acquisitions",
	"wiredtiger.lock.checkpoint_lock_application_thread_wait_time_(usecs)",
	"wiredtiger.lock.checkpoint_lock_internal_thread_wait_time_(usecs)",
	"wiredtiger.lock.dhandle_lock_application_thread_time_waiting_(usecs)",
	"wiredtiger.lock.dhandle_lock_internal_thread_time_waiting_(usecs)",
	"wiredtiger.lock.durable_timestamp_queue_lock_application_thread_time_waiting_(usecs)",
	"wiredtiger.lock.durable_timestamp_queue_lock_internal_thread_time_waiting_(usecs)",
	"wiredtiger.lock.metadata_lock_application_thread_wait_time_(usecs)",
	"wiredtiger.lock.metadata_lock_internal_thread_wait_time_(usecs)",
	"wiredtiger.lock.read_timestamp_queue_lock_application_thread_time_waiting_(usecs)",
	"wiredtiger.lock.read_timestamp_queue_lock_internal_thread_time_waiting_(usecs)",
	"wiredtiger.lock.schema_lock_application_thread_wait_time_(usecs)",
	"wiredtiger.lock.schema_lock_internal_thread_wait_time_(usecs)",
	"wiredtiger.lock.table_lock_application_thread_time_waiting_for_the_table_lock_(usecs)",
	"wiredtiger.lock.table_lock_internal_thread_time_waiting_for_the_table_lock_(usecs)",
	"wiredtiger.lock.txn_global_lock_application_thread_time_waiting_(usecs)",
	"wiredtiger.lock.txn_global_lock_internal_thread_time_waiting_(usecs)",
	"wiredtiger.log.log_flush_operations",
	"wiredtiger.log.log_force_write_operations",
	"wiredtiger.log.log_force_write_operations_skipped",
	"wiredtiger.log.log_scan_operations",
	"wiredtiger.log.log_sync_operations",
	"wiredtiger.log.log_sync_dir_operations",
	"wiredtiger.log.log_write_operations",
	"wiredtiger.log.log_bytes_of_payload_data",
	"wiredtiger.log.log_bytes_written",
	"wiredtiger.log.logging_bytes_consolidated",
	"wiredtiger.log.total_log_buffer_size",
	"wiredtiger.transaction.prepared_transactions",
	"wiredtiger.transaction.query_timestamp_calls",
	"wiredtiger.transaction.rollback_to_stable_calls",
	"wiredtiger.transaction.set_timestamp_calls",
	"wiredtiger.transaction.transaction_begins",
	"wiredtiger.transaction.transaction_sync_calls",
	"wiredtiger.transaction.transactions_committed",
	"wiredtiger.transaction.transactions_rolled_back",
