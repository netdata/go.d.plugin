...
var (
	...
	chartMQTTv5DISCONNECTSentReason = Chart{
		...
		Dims: Dims{
			...
			{ID: join(metricDISCONNECTSent, "disconnect_with_will_msg"), Name: "disconnect_with_will_msg", Algo: module.Incremental},
			...
			{ID: join(metricDISCONNECTSent, "payload_format_invalid"), Name: "payload_format_invalid", Algo: module.Incremental},
		},
	}
)
