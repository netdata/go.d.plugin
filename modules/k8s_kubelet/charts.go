...
var charts = Charts{
	...
	{
		ID:    "apiserver_storage_data_key_generation_latencies_microseconds",
		Title: "API Server Latencies Of Data Encryption Key(DEK) Generation Operations",
		Units: "observes",
		Fam:   "api server",
		Ctx:   "k8s_kubelet.apiserver_storage_data_key_generation_latencies_microseconds",
		Type:  module.Stacked,
		Dims: Dims{
			{ID: "apiserver_storage_data_key_generation_bucket_5", Name: "5 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_10", Name: "10 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_20", Name: "20 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_40", Name: "40 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_80", Name: "80 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_160", Name: "160 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_320", Name: "320 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_640", Name: "640 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_1280", Name: "1280 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_2560", Name: "2560 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_5120", Name: "5120 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_10240", Name: "10240 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_20480", Name: "20480 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_40960", Name: "40960 µs"},
			{ID: "apiserver_storage_data_key_generation_bucket_+Inf", Name: "+Inf"},
		},
	},
	{
