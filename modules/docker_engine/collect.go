...
func (de *DockerEngine) collectMetrics(pms prometheus.Metrics) metrics {
	var mx metrics
...
func isSwarmManager(pms prometheus.Metrics) bool {
	return pms.FindByName("swarm_node_manager").Max() == 1
}

func hasContainerStates(pms prometheus.Metrics) bool {
