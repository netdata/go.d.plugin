...
var serverCharts = Charts{
	{
		...
		Title: "Number Of DNS Requests, %s",
		Units: "requests/s",
		Fam:   "server %s",
		Ctx:   "coredns.dns_request_count_total",
		Dims: Dims{
	...
	},
	{
		...
		Title: "Number Of DNS Responses, %s",
		Units: "responses/s",
		Fam:   "server %s",
		Ctx:   "coredns.dns_responses_count_total",
		Dims: Dims{
	...
	},
	{
		...
		Title: "Number Of Processed And Dropped DNS Requests, %s",
		Units: "requests/s",
		Fam:   "server %s",
		Ctx:   "coredns.dns_request_count_total_per_status",
		Type:  module.Stacked,
	...
	},
	{
		...
		Title: "Number Of DNS Requests Per Transport Protocol, %s",
		Units: "requests/s",
		Fam:   "server %s",
	...
	},
	{
		...
		Title: "Number Of DNS Requests Per IP Family, %s",
		Units: "requests/s",
		Fam:   "server %s",
	...
	},
	{
		...
		Title: "Number Of DNS Requests Per Type, %s",
		Units: "requests/s",
		Fam:   "server %s",
	...
	},
	{
		...
		Title: "Number Of DNS Responses Per Rcode, %s",
		Units: "responses/s",
		Fam:   "server %s",
