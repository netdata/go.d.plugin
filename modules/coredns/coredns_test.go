...
func TestCoreDNS_Collect(t *testing.T) {
	...
	expected := map[string]int64{
		...
		"dns://:53_request_by_status_processed": 65,
		"dns://:53_request_by_type_A":           45,
		"dns://:53_request_by_type_AAAA":        15,
		...
		"dns://:53_response_by_rcode_BADALG":    0,
		"dns://:53_response_by_rcode_BADCOOKIE": 0,
		"dns://:53_response_by_rcode_BADKEY":    0,
		"dns://:53_response_by_rcode_BADMODE":   0,
		"dns://:53_response_by_rcode_BADNAME":   0,
		"dns://:53_response_by_rcode_BADSIG":    0,
		"dns://:53_response_by_rcode_BADTIME":   0,
		"dns://:53_response_by_rcode_BADTRUNC":  0,
		"dns://:53_response_by_rcode_FORMERR":   0,
		"dns://:53_response_by_rcode_NOERROR":   3,
		"dns://:53_response_by_rcode_NOTAUTH":   0,
		"dns://:53_response_by_rcode_NOTIMP":    0,
		"dns://:53_response_by_rcode_NOTZONE":   0,
		"dns://:53_response_by_rcode_NXDOMAIN":  0,
		"dns://:53_response_by_rcode_NXRRSET":   0,
		"dns://:53_response_by_rcode_REFUSED":   0,
		"dns://:53_response_by_rcode_SERVFAIL":  58,
		"dns://:53_response_by_rcode_YXDOMAIN":  0,
		"dns://:53_response_by_rcode_YXRRSET":   0,
		"dns://:53_response_by_rcode_other":     0,
		"dns://:53_response_total":              61,
		"no_server_dropped":                     111,
		"panic_total":                           99,
		"request_by_ip_family_v4":               119,
		"request_by_ip_family_v6":               62,
		"request_by_proto_tcp":                  62,
		"request_by_proto_udp":                  119,
		"request_by_status_dropped":             58,
		"request_by_status_processed":           65,
		"request_by_type_A":                     45,
		"request_by_type_AAAA":                  15,
		...
		"request_total":                         181,
		"response_by_rcode_BADALG":              0,
		"response_by_rcode_BADCOOKIE":           0,
		"response_by_rcode_BADKEY":              0,
		"response_by_rcode_BADMODE":             0,
		"response_by_rcode_BADNAME":             0,
		"response_by_rcode_BADSIG":              0,
		"response_by_rcode_BADTIME":             0,
		"response_by_rcode_BADTRUNC":            0,
		"response_by_rcode_FORMERR":             0,
		"response_by_rcode_NOERROR":             3,
		"response_by_rcode_NOTAUTH":             0,
		"response_by_rcode_NOTIMP":              0,
		"response_by_rcode_NOTZONE":             0,
		"response_by_rcode_NXDOMAIN":            0,
		"response_by_rcode_NXRRSET":             0,
		"response_by_rcode_REFUSED":             0,
		"response_by_rcode_SERVFAIL":            58,
		"response_by_rcode_YXDOMAIN":            0,
		"response_by_rcode_YXRRSET":             0,
		"response_by_rcode_other":               0,
		"response_total":                        61,
	}
