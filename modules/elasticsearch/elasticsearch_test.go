	...
	tests := map[string]struct {
		...
		"v790": {
			...
			wantCollected: map[string]int64{
				...
				"cluster_stats_active_shards":                                  0,
				"cluster_stats_active_shards_percent_as_number":                100,
				"cluster_stats_delayed_unassigned_shards":                      0,
				"cluster_stats_initializing_shards":                            0,
				"cluster_stats_number_of_data_nodes":                           1,
				"cluster_stats_number_of_in_flight_fetch":                      0,
				"cluster_stats_number_of_nodes":                                1,
