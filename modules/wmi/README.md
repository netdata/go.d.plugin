...
| adcs_cert_requests_total                                    |    Template    |                                                                                      requests                                                                                      |   requests/s   |
| adcs_cert_req_proc_time_elapsed                             |    Template    |                                                                                       period                                                                                       |    seconds     |
| adcs_cert_retrieval_total                                   |    Template    |                                                                                     retrievals                                                                                     |  retrievals/s  |
| adcs_cert_retrieval_time_elapsed                            |    Template    |                                                                                       period                                                                                       |    seconds     |
| adcs_cert_failed_request_total                              |    Template    |                                                                                      requests                                                                                      |   requests/s   |
| adcs_cert_issued_request_total                              |    Template    |                                                                                      requests                                                                                      |   requests/s   |
| adcs_cert_pending_request_total                             |    Template    |                                                                                      requests                                                                                      |   requests/s   |
| adcs_crypto_signing_time_elapsed                            |    Template    |                                                                                       period                                                                                       |    seconds     |
| adcs_policy_mod_proc_time_elapsed                           |    Template    |                                                                                       period                                                                                       |    seconds     |
| adcs_challenge_cert_response_total                          |    Template    |                                                                                      responses                                                                                     |   responses/s  |
| adcsd_challenge_response_proc_time_elapsed                  |    Template    |                                                                                       period                                                                                       |    seconds     |
| adcs_signed_cert_timestamp_list_total                       |    Template    |                                                                                    certificates                                                                                    | certificates/s |
| adcsd_signed_cert_timestamp_list_proc_elapsed               |    Template    |                                                                                       period                                                                                       |    seconds     |
