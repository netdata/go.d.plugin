...
| adfs_external_authentications                                        |        global        |                                                                                   failure, success                                                                                  |authentications/s|
...
| adfs_oauth_client_authentication                                     |        global        |                                                                                   failure, success                                                                                 |authentications/s|
| adfs_oauth_client_credentials                                        |        global        |                                                                                   failure, success                                                                                 |  credentials/s  |
| adfs_oauth_client_privkey_jwt_authentications                        |        global        |                                                                                   failure, success                                                                                 |    requests/s   |
| adfs_oauth_client_secret_basic_authentications                       |        global        |                                                                                   failure, success                                                                                 |authentications/s|
| adfs_oauth_client_secret_post_authentications                        |        global        |                                                                                   failure, success                                                                                 |authentications/s|
| adfs_oauth_client_windows_authentications                            |        global        |                                                                                   failure, success                                                                                  |authentications/s|
| adfs_oauth_logon_certificate_requests_failure                        |        global        |                                                                                      requests                                                                                      |   requests/s    |
| adfs_oauth_logon_certificate_token_requests_success                  |        global        |                                                                                      RP tokens                                                                                     |   rp_tokens/s   |
| adfs_oauth_password_grant_requests                                   |        global        |                                                                                   failure, success                                                                                 |   requests/s    |
| adfs_oauth_password_grant_requests                                   |        global        |                                                                                   failure, success                                                                                 |   requests/s    |
| adfs_oauth_token_requests_success                                    |        global        |                                                                                      RP tokens                                                                                     |   rp_tokens/s   |
| adfs_passive_requests                                                |        global        |                                                                                      requests                                                                                      |   requests/s    |
| adfs_passport_authentications                                        |        global        |                                                                                      requests                                                                                      |   requests/s    |
| adfs_password_change                                                 |        global        |                                                                                   failed, success                                                                                  |   requests/s   |
| adfs_samlp_token_requests_success                                    |        global        |                                                                                      RP tokens                                                                                     |   rp_tokens/s   |
| adfs_sso_authentications                                             |        global        |                                                                                   failure, success                                                                                 |authentications/s|
...
| adfs_wsfed_token_requests_success                                    |        global        |                                                                                   authentications                                                                                  |authentications/s|
| adfs_wstrust_token_requests_success                                  |        global        |                                                                                      RP tokens                                                                                     |   rp_tokens/s   |
