...
| net_framework.exception_thrown                                       |        global        |                                                                           <i>a dimension per process</i>                                                                           |    exceptions     |
| net_framework.exception_filters                                      |        global        |                                                                           <i>a dimension per process</i>                                                                           |    exceptions     |
| net_framework.exception_finally                                      |        global        |                                                                           <i>a dimension per process</i>                                                                           |      blocks       |
| net_framework.exception_throw_catch_depth                            |        global        |                                                                           <i>a dimension per process</i>                                                                           |    stack frames   |
| net_framework.clrinterop_com_callable_wrapper                        |        global        |                                                                           <i>a dimension per process</i>                                                                           |        CCW        |
| net_framework.clrinterop_marshalling                                 |        global        |                                                                           <i>a dimension per process</i>                                                                           |  values marshaled |
| net_framework.clrinterop_stubs_created                               |        global        |                                                                           <i>a dimension per process</i>                                                                           |       stubs       |
| net_framework.clrjit_methods                                         |        global        |                                                                           <i>a dimension per process</i>                                                                           |    JIT Methods    |
| net_framework.clrjit_time                                            |        global        |                                                                           <i>a dimension per process</i>                                                                           |     Percentage    |
| net_framework.clrjit_standard_failure                                |        global        |                                                                           <i>a dimension per process</i>                                                                           |     Failures      |
| net_framework.clrjit_il_bytes                                        |        global        |                                                                           <i>a dimension per process</i>                                                                           |       bytes       |
| net_framework.clrloading_loader_heap_size                            |        global        |                                                                           <i>a dimension per process</i>                                                                           |       bytes       |
| net_framework.clrloading_appdomains_loaded                           |        global        |                                                                           <i>a dimension per process</i>                                                                           | application domain|
| net_framework.clrloading_appdomains_unloaded                         |        global        |                                                                           <i>a dimension per process</i>                                                                           | application domain|
| net_framework.clrloading_assemblies_unloaded                         |        global        |                                                                           <i>a dimension per process</i>                                                                           |     assemblies    |
| net_framework.clrloading_classes_loaded                              |        global        |                                                                           <i>a dimension per process</i>                                                                           |      classes      |
| net_framework.clrloading_class_load_failure                          |        global        |                                                                           <i>a dimension per process</i>                                                                           |      classes      |
| net_framework.clrlockandthreads_queue_length                         |        global        |                                                                           <i>a dimension per process</i>                                                                           |      threads      |
| net_framework.clrlockandthreads_current_logical_threads              |        global        |                                                                           <i>a dimension per process</i>                                                                           |      threads      |
| net_framework.clrlockandthreads_current_physical_threads             |        global        |                                                                           <i>a dimension per process</i>                                                                           |      threads      |
| net_framework.clrlockandthreads_recognized_threads                   |        global        |                                                                           <i>a dimension per process</i>                                                                           |      threads      |
| net_framework.clrlockandthreads_contentions                          |        global        |                                                                           <i>a dimension per process</i>                                                                           |      threads      |
| net_framework.clrmemory_allocated_bytes                              |        global        |                                                                           <i>a dimension per process</i>                                                                           |       bytes       |
| net_framework.clrmemory_finalization_survivors                       |        global        |                                                                           <i>a dimension per process</i>                                                                           |      objects      |
| net_framework.clrmemory_heap_size                                    |        global        |                                                                           <i>a dimension per process</i>                                                                           |       bytes       |
| net_framework.clrmemory_promoted                                     |        global        |                                                                           <i>a dimension per process</i>                                                                           |       bytes       |
| net_framework.clrmemory_number_gc_handles                            |        global        |                                                                           <i>a dimension per process</i>                                                                           |      handles      |
| net_framework.clrmemory_collections                                  |        global        |                                                                           <i>a dimension per process</i>                                                                           |        GC         |
| net_framework.clrmemory_induced_gc                                   |        global        |                                                                           <i>a dimension per process</i>                                                                           |        GC         |
| net_framework.clrmemory_number_pinned_objects                        |        global        |                                                                           <i>a dimension per process</i>                                                                           |      objects      |
| net_framework.clrmemory_number_sink_blocks_in_use                    |        global        |                                                                           <i>a dimension per process</i>                                                                           |       blocks      |
| net_framework.clrmemory_reserved                                     |        global        |                                                                           <i>a dimension per process</i>                                                                           |       bytes       |
| net_framework.clrmemory_gc_time                                      |        global        |                                                                           <i>a dimension per process</i>                                                                           |     percentage    |
| net_framework.clrremoting_channel                                    |        global        |                                                                           <i>a dimension per process</i>                                                                           |      channels     |
| net_framework.clrremoting_context_bound_classes_loaded               |        global        |                                                                           <i>a dimension per process</i>                                                                           |   context-bound   |
| net_framework.clrremoting_context_bound_objects                      |        global        |                                                                           <i>a dimension per process</i>                                                                           |      objects      |
| net_framework.clrremoting_context_proxies                            |        global        |                                                                           <i>a dimension per process</i>                                                                           |      objects      |
| net_framework.clrremoting_contexts                                   |        global        |                                                                           <i>a dimension per process</i>                                                                           |      contexts     |
| net_framework.clrremoting_calls                                      |        global        |                                                                           <i>a dimension per process</i>                                                                           |        RPC        |
