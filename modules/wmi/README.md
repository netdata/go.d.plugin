...
| mssql_instance_memmgr_external_benefit_of_memory                     |    mssql instance    |                                                                                      memory                                                                                       |       bytes       |
...
| mssql_instance_sql_errors_total                                      |    mssql instance    |                                                                        offline, info, kill connection, user                                                                        |      errors       |
| mssql_instance_sqlstats_auto_parameterization_attempts               |    mssql instance    |                                                                                       failed                                                                                       |    attempts/s     |
| mssql_instance_sqlstats_batch_requests                               |    mssql instance    |                                                                                     requests                                                                                      |     requests/s    |
