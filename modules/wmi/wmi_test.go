	...
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"mssql_instance_SQLEXPRESS_state_auto_param":                                37,
				"mssql_instance_SQLEXPRESS_state_compilation":                               376,
				"mssql_instance_SQLEXPRESS_state_recompilation":                             8,
				"mssql_instance_SQLEXPRESS_state_safe_auto":                                 2,
