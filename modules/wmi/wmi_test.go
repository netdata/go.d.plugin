	...
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"net_nic_Intel_R_PRO_1000_MT_Network_Connection_bytes_total":    46501921360,
				...
				"net_nic_Intel_R_PRO_1000_MT_Network_Connection_packets_total":              5453335,
