	...
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"adcs_cert_template_DomainController_request_policy_module_processing_time_seconds":             0,
				"adcs_cert_template_DomainController_request_processing_time_seconds":                           0,
