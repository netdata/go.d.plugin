	...
	tests := map[string]struct {
		...
		"success on valid response v0.15.0": {
			...
			wantCollected: map[string]int64{
				...
				"cpu_core_0,0_frequency":                                      2195000,
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"cpu_core_0,0_frequency":                                   2803000,
				...
				"cpu_core_0,1_frequency":                                   2803000,
				...
				"cpu_core_0,2_frequency":                                   2803000,
				...
				"cpu_core_0,3_frequency":                                   2803000,
				...
				"cpu_core_0,4_frequency":                                   1001000,
				...
				"cpu_core_0,5_frequency":                                   2803000,
				...
				"cpu_core_0,6_frequency":                                   2803000,
				...
				"cpu_core_0,7_frequency":                                   1001000,
