	...
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"os_processes":                                                  119, "os_processes_limit": 4294967295,
				"os_time":                           1666394276,
				"os_users":                          1,
				...
				"tcp_conn_active_ipv4":              96883,
				"tcp_conn_active_ipv6":              67,
				"tcp_conn_established_ipv4":         3,
				"tcp_conn_established_ipv6":         2,
				"tcp_conn_failure_ipv4":             7587,
				"tcp_conn_failure_ipv6":             6,
				"tcp_conn_passive_ipv4":             20108,
				"tcp_conn_passive_ipv6":             61,
				"tcp_conn_reset_ipv4":               14793,
				"tcp_conn_reset_ipv6":               2,
