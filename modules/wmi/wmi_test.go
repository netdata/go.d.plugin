	...
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"ad_dra_objects_filtered_inbound":       0,
				"ad_dra_objects_remaining_inbound":      0,
				"ad_dra_pending_sync_directory":         0,
				"ad_dra_properties_applied_inbound":     0,
				"ad_dra_properties_filtered_inbound":    0,
