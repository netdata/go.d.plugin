	...
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"net_framework_WMSvc_exception_filters_total":                                                   0,
				"net_framework_WMSvc_exception_finally_total":                                                   0,
				"net_framework_WMSvc_exception_throw_catch_depth_total":                                         0,
				"net_framework_WMSvc_exception_thrown_total":                                                    0,
				...
				"net_framework_powershell_exception_filters_total":                                              0,
				"net_framework_powershell_exception_finally_total":                                              56,
				"net_framework_powershell_exception_throw_catch_depth_total":                                    140,
				"net_framework_powershell_exception_thrown_total":                                               37,
