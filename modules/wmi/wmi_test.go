	...
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"adfs_ad_login_connection_failure_total":                                                        0,
				...
				"adfs_db_config_query_time_seconds_total":                                                       0,
				...
				"adfs_oauth_client_privkey_jwt_authentications_failure_total":                                   0,
				...
				"adfs_password_change_success_total":                                                            0,
