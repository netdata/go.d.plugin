	...
	tests := map[string]struct {
		...
		"success on valid response v0.20.0": {
			...
			wantCollected: map[string]int64{
				...
				"system_boot_time":                                              1664541994,
				"system_calls_total":                                            1307128419000,
				"system_collection_duration":                                    0,
				"system_collection_success":                                     1,
				"system_context_switches_total":                                 282815945000,
				"system_exception_dispatches_total":                             309788000,
				"system_processor_queue_length":                                 0,
				"system_threads":                                                1125,
				"system_up_time":                                                0,
				"tcp_active_ipv4":                                               96883,
				"tcp_active_ipv6":                                               67,
				"tcp_collection_duration":                                       0,
				"tcp_collection_success":                                        1,
				"tcp_established_ipv4":                                          3,
				"tcp_established_ipv6":                                          2,
				"tcp_failure_ipv4":                                              7587,
				"tcp_failure_ipv6":                                              6,
				"tcp_passive_connection_ipv4":                                   20108,
				"tcp_passive_connection_ipv6":                                   61,
				"tcp_reset_ipv4":                                                14793,
				"tcp_reset_ipv6":                                                2,
				...
				"tcp_segments_total_ipv4":                                       4168732,
				"tcp_segments_total_ipv6":                                       12426,
