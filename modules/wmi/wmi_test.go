...
var (
	testAllData, _     = ioutil.ReadFile("testdata/all_metrics.txt")
	testPartialData, _ = ioutil.ReadFile("testdata/partial_metrics.txt")
)
...
func TestWMI_Init(t *testing.T) {
	...
	assert.NotNil(t, job.collected.collection)
...
func TestWMI_Collect(t *testing.T) {
	...
	expected := map[string]int64{
		...
		"cpu_user":                                                    311468,
		"cs_collection_duration":                                      490,
		"cs_collection_success":                                       1,
		...
		"memory_cache_total":                                          1336434688000,
		"memory_collection_duration":                                  595,
		...
		"memory_not_committed_bytes":                                  4163584000000,
		...
		"memory_standby_cache_total":                                  1310584832000,
		...
		"memory_used_bytes":                                           1811202048000,
		...
		"net_collection_duration":           415,
		"net_collection_success":            1,
		"os_collection_duration":            567,
		...
		"system_collection_duration":        511,
...
func TestWMI_CollectPartial(t *testing.T) {
	...
	expected := map[string]int64{
		"cpu_collection_duration": 38,
		"cpu_collection_success":  1,
		"cpu_core_0_c1":           43636384,
		"cpu_core_0_c2":           0,
		"cpu_core_0_c3":           0,
		"cpu_core_0_dpc":          8156,
		"cpu_core_0_dpcs":         1044908000,
		"cpu_core_0_idle":         43636384,
		"cpu_core_0_interrupt":    21609,
		"cpu_core_0_interrupts":   121952587000,
		"cpu_core_0_privileged":   2388687,
		"cpu_core_0_user":         2308984,
		"cpu_core_1_c1":           43750474,
		"cpu_core_1_c2":           0,
		"cpu_core_1_c3":           0,
		"cpu_core_1_dpc":          32968,
		"cpu_core_1_dpcs":         1006906000,
		"cpu_core_1_idle":         43750474,
		"cpu_core_1_interrupt":    114265,
		"cpu_core_1_interrupts":   35063753000,
		"cpu_core_1_privileged":   1913640,
		"cpu_core_1_user":         2437281,
		"cpu_dpc":                 41125,
		"cpu_idle":                87386858,
		"cpu_interrupt":           135875,
		"cpu_privileged":          4302328,
		"cpu_user":                4746265,
	}
