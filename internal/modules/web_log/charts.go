...
func chartPerCategoryStats(id string) []Chart {
	return []Chart{
		...
		},
		{
			...
			Opts: Opts{
				Title: "chartBandwidth", Units: "kilobits/s", Fam: id, Ctx: "web_log.url_bandwidth", Type: charts.Area},
			Dims: Dims{
		...
		},
		{
			...
			Opts: Opts{
				Title: "Processing Time", Units: "milliseconds", Fam: id, Ctx: "web_log.url_response_time", Type: charts.Area},
			Dims: Dims{
