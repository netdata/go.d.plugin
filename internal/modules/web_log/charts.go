	...
	return []Chart{
		{
			...
			Opts: Opts{Title: "Detailed Response Codes 1xx", Units: "requests/s", Family: "responses", Type: charts.Stacked},
		},
		{
			ID:   chartRespCodesDetailed.ID + "_2xx",
			Opts: Opts{Title: "Detailed Response Codes 2xx", Units: "requests/s", Family: "responses", Type: charts.Stacked},
		},
		{
			ID:   chartRespCodesDetailed.ID + "_3xx",
			Opts: Opts{Title: "Detailed Response Codes 3xx", Units: "requests/s", Family: "responses", Type: charts.Stacked},
		},
		{
			ID:   chartRespCodesDetailed.ID + "_4xx",
			Opts: Opts{Title: "Detailed Response Codes 4xx", Units: "requests/s", Family: "responses", Type: charts.Stacked},
		},
		{
			ID:   chartRespCodesDetailed.ID + "_5xx",
			Opts: Opts{Title: "Detailed Response Codes 5xx", Units: "requests/s", Family: "responses", Type: charts.Stacked},
		},
		{
			ID:   chartRespCodesDetailed.ID + "_other",
			Opts: Opts{Title: "Detailed Response Codes Other", Units: "requests/s", Family: "responses", Type: charts.Stacked},
		},
	}
}
